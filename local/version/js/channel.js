...
// 第一页
    ...
    $.ajax({
        ...
        url: baseUrlChannel + '/white_label/invest/access_careers',
        success: function (res) {
            d = res.body;
            var html = '';
            $.each(d, function (i) {
    ...
    $.ajax({
        ...
        contentType: 'application/json',
        data: pd,
        url: baseUrlChannel + '/white_label/invest/access_district',
        success: function (res) {
            d = res.body;
            var html = '';
            $.each(d, function (i) {
    ...
    $(".button").on('click', function () {
        ...
        if (non_us) {
            ...
            $.ajax({
                ...
                contentType: 'application/json',
                data: data,
                url: baseUrlChannel + '/white_label/invest/access_bank_dic',
                success: function (res) {
                    d = res.body;
                    var html = '';
                    $.each(d, function (i) {
...
//第四页
    ...
    $(".step-four").on('click', function () {
        ...
        $.ajax({
            ...
            contentType: 'application/json',
            data: product,
            url: baseUrlChannel + '/white_label/product_document',
    ...
    $("#get-invest-document").on('click', '.documents a', function () {
        ...
        bank_non_us = {
            ...
            'bank_name': bank_name,
            'have_middle_bank': have_middle_bank,
            'middle_bank_address': middle_bank_address,
            'middle_bank_name': middle_bank_name,
            'middle_bank_swift_code': middle_bank_swift_code,
            'swift_code': swift_code
        };
        bank_us = {
            'account_number': account_number, 'account_type': account_type, 'bank_address': bank_address,
        ...
        base_info = {
            ...
            'nationality': '中国',
            'source_of_capital': source_of_income,
            'ssn': ''
        };
        address_cn = {
            'city': city, 'country': '中国', 'detail': address_detail, 'district': county,
            'postal_code': post_code, 'region': region
        };
        accreditation = {
            "debt_amount": 0, "spouse_email": "string", "spouse_first_name": "string",
            "spouse_last_name": "string", "spouse_phone": "string", "type": "INCOME", "with_spouse": false
        };
        addreess_non_cn = {
            'city': city, 'country': '中国', 'line1': 'line1', 'line2': 'line2',
            'postal_code': 'postal_code', 'region': 'region'
        };
        pdf = {
            'address_non_cn': addreess_non_cn,
            'address_type': 'CN',
            'bank_non_us': bank_non_us,
            'bank_type': bank_type,
            'bank_us': bank_us,
            'base_info': base_info,
            'bill_expire_date': '',
            ...
            'investor_type': '1',
            'id_card_url': address_photo,
            'id_card_expire_date': address_effective,
            'passport_url': passport_photo,
            'passport_number': passport_number,
            'passport_expire_date': effective,
            'signature': signature,
            'phone': phone,
            'spouse_signature': ''
        };
...
//点击完成 创建用户 && 创建订单
    ...
    $("body").on('click', '#finish', function () {
        ...
        $.ajax({
            ...
            contentType: 'application/json',
            data: userInfoReqVo,
            url: baseUrlChannel + '/white_label/invest/operate_user',
            success: createUsers
        });
