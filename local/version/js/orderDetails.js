        ...
        if (d && d != null) {
            ...
            if (fa_investment_status &&
                ...
                var order_control = '<div class="row">' +
                    ...
                    '<div class="col-md-12">';
                if (fa_investment_status == 'not_commit') {
                    order_control += '<a style="display: block;" href="/auxiliary_order/stepOne.html?product_id=' + product_id + '&phone=' + phone + '&order_number=' + order_number + '&channel_code=' + advisor_code + '">修改订单</a>';
                }
                if (is_admin) {
